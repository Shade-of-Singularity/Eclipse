...
namespace ServiceCore
{
    ...
    public abstract class QuitHandler
    {
        ...
        private static volatile bool m_Enabled = false; // Enabled by ServiceCore.Engine callback during initialization.
        ...
        /// ===     ===     ===     ===    ===  == =  -                        -  = ==  ===    ===     ===     ===     ===]]>
        /// <summary>
        /// Quit handler which prevents <see cref="Console.CancelKeyPress"/> callback.
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        protected abstract void Interrupt(object sender, ConsoleCancelEventArgs args);
