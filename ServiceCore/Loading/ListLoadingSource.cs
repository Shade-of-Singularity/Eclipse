...
{
    /// <summary>
    /// Source of <see cref="ILoadable"/>s in the array format.
    /// </summary>
    ...
    public sealed class ListLoadingSource(string identifier, Version version, IList<ILoadable> loadable, DependencyDeclaration[] dependencies) : ILoadingSource
    {
        /// <inheritdoc/>
