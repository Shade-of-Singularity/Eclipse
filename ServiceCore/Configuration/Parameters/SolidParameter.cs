...
namespace ServiceCore.Configuration.Parameters
{
    ...
    public sealed class SolidParameter<TValue> : AbstractParameter where TValue : IConvertible, IEquatable<TValue>
    {
        ...
        /// ===     ===     ===     ===    ===  == =  -                        -  = ==  ===    ===     ===     ===     ===]]>
        /// <inheritdoc/>
        public override bool IsDirty => false; // Values are immediately applied.
        ...
        /// (e.g. when <see cref="IsDefault"/>) - will set <see cref="Value"/> to a new <see cref="DefaultValue"/>.
        /// <para>
