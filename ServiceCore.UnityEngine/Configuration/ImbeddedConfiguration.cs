...
namespace ServiceCore.Configuration
{
    ...
    /// Used by <see cref="ServiceCore"/> to retrieve settings that are used before <see cref="Engine.Initialize"/> happens.
    /// </summary>
    /// <remarks>
    ...
    public abstract class ImbeddedConfiguration : ScriptableObject
    {
        ...
        /// .
        /// ===     ===     ===     ===    ===  == =  -                        -  = ==  ===    ===     ===     ===     ===]]>
        private static readonly Dictionary<Type, ImbeddedConfiguration> m_Configurations = [];
        ...
        private static void Initialize()
        {
            ...
            for (int i = 0; i < configurations.Length; i++)
            {
                ...
                while (type is not null && type != typeof(ImbeddedConfiguration))
                {
