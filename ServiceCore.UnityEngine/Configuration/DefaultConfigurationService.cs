...
namespace ServiceCore.Configuration
{
    ...
    public abstract class DefaultConfigurationService : IConfigurationService
    {
        ...
        /// ===     ===     ===     ===    ===  == =  -                        -  = ==  ===    ===     ===     ===     ===]]>
        // Static Fields:
        protected static readonly Dictionary<string, Action> m_StandaloneSetters = [];
        ...
        // Local Fields:
        private readonly Dictionary<Type, EngineConfiguration> m_EngineConfigurations = [];
        private readonly Dictionary<Type, GameState> m_GameStates = [];
