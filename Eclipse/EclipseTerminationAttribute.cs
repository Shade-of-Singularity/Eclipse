...
{
    /// <summary>
    /// Runs methods with this attribute when <see cref="Eclipse"/>.<see cref="Engine"/> terminates.
    /// </summary>
    /// <remarks>
    /// Unless <see cref="Engine.Terminate"/> is called, called only on <see cref="UnityEngine.Application.quitting"/>.
    /// </remarks>
    [AttributeUsage(AttributeTargets.Method, AllowMultiple = false, Inherited = false)]
    public sealed class EclipseTerminationAttribute : Attribute
    {
        /// <summary>
        /// When attribute should be employed.
        /// </summary>
        public readonly TerminationTiming Timing;
        ...
        public EclipseTerminationAttribute(TerminationTiming timing)
        {
            Timing = timing;
        }
    }
