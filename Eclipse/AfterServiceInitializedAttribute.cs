...
namespace Eclipse
{
    ...
    public sealed class AfterServiceInitializedAttribute : Attribute
    {
        /// ===     ===     ===     ===    ===  == =  -                        -  = ==  ===    ===     ===     ===     ===<![CDATA[
        /// .
        /// .                                              Public Properties
        ...
        /// ===     ===     ===     ===    ===  == =  -                        -  = ==  ===    ===     ===     ===     ===]]>
        /// <summary>
        /// Default .ctor. Defines mandatory <see cref="Service"/>.
        /// </summary>
        public AfterServiceInitializedAttribute(Type service) => Service = service;
    }
}
