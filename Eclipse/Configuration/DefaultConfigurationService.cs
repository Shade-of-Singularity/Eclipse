...
namespace Eclipse.Configuration
{
    public sealed class DefaultConfigurationService : ConfigurationService
    {
        ...
        /// ===     ===     ===     ===    ===  == =  -                        -  = ==  ===    ===     ===     ===     ===]]>
        /// <summary>
        /// Default initialization order of <see cref="ConfigurationService"/>.
        /// </summary>
        ...
        // Events:
        //public static event ConfigurationChangedHandler OnConfigurationChanged;
        ...
        private static readonly Dictionary<string, Action> m_StandaloneSetters = new Dictionary<string, Action>();
        ...
        /// ===     ===     ===     ===    ===  == =  -                        -  = ==  ===    ===     ===     ===     ===]]>
        /// <summary>
        /// Allows you to set an parameters which require high performance using special method.
        /// </summary>
        public static void Set(string id, int value)
        {
            m_StandaloneSetters[id] = () => EngineService<ConfigurationService>.Instance.m_Storage.Save;
        }
